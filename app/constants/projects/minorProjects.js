...
The website includes service listings, contact forms, testimonials, and clear calls-to-action. The responsive design ensures optimal viewing experience across all devices, from desktop computers to mobile phones.
...
The application features a responsive design that works seamlessly across desktop and mobile devices, built-in social sharing capabilities, and basic analytics to track post performance. It uses Firebase for authentication and data storage, providing a serverless architecture that's both scalable and cost-effective.

BlogSquirrel was built using React for the frontend with custom CSS for styling. Firebase handles authentication, data storage, and hosting, making it a complete solution that's easy to deploy and maintain.`,
    metadata: {
      completionDate: "August 2024",
      category: "Web App, Personal Blog",
      duration: "2 weeks",
      purpose: "To create a simplified blogging platform for personal use"
    }
  },
  {
    id: "simply",
...
Key features include interactive mortgage calculators, detailed service listings, educational resources about UAE mortgages, clear calls-to-action, and a responsive design that works flawlessly on all devices.
