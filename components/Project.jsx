...
const Project = () => {
  ...
  const enhancedProjects = useMemo(() => {
    return filteredProjects.map(project => {
      ...
      if (project.title.includes("Care4Brain") || project.description.toLowerCase().includes("health")) {
        tags.push("Health");
      }
      ...
      const featured = ["Dubbby", "Care4Brain", "Blog Squirrel", "Simply Mortgage"].includes(project.title);
      ...
      else if (project.title === "Care4Brain") {
    ...
    <section ref={ref} id="Projects" className="w-full py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-12">
          ...
          {displayedProjects
            .filter(project => project.title === "Care4Brain")
            .slice(0, 1)
            .map((project, index) => (
